...
# Project imports
from hiddenStrings.builder.modules.body import leg
from hiddenStrings.libs.helpers import windowHelper


class LegWindow(windowHelper.WindowHelper):
    def __init__(self, *args):
        ...
        self.hook = cmds.textFieldGrp(label='Base: ', text='spineOutputs_c_grp.spineBottom_c_ctr')
