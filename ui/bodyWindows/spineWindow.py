...
# Project imports
from hiddenStrings.builder.modules.body import column
from hiddenStrings.libs.helpers import windowHelper


class SpineWindow(windowHelper.WindowHelper):
    def __init__(self, *args):
        ...
        """
        super().__init__(title='Spine Guides Options', size=(450, 450))
        ...
        self.hook = cmds.textFieldGrp(label='Base: ', text='rootOutputs_c_grp.root_c_ctr')
